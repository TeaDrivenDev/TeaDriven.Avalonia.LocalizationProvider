module TeaDriven.AvaloniaLocalization.FSharpTests
...
type Generative2 = TeaDriven.AvaloniaLocalization.FSharp.GenerativeProvider<2>
type Generative4 = TeaDriven.AvaloniaLocalization.FSharp.GenerativeProvider<4>
